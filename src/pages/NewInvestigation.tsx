...
import { Search, GitCompare, ArrowRight, Calendar, Globe, Video } from "lucide-react";
import { toast } from "sonner";
import { cn } from "@/lib/utils";

type InvestigationType = "topic" | "compare";

export default function NewInvestigation() {
  const [type, setType] = useState<InvestigationType>("topic");
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">
                Scan multiple videos on a topic to find contradictions automatically
              </p>
            </button>
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">
                Compare two specific videos to analyze their differences
              </p>
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="glass-card p-8">
            ...
            <div className="mt-8">
              <Button variant="gradient" size="xl" className="w-full group" type="submit">
                {type === "topic" ? "Run Contradiction Scan" : "Compare Videos"}
