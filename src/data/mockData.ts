...
export const demoInvestigation = {
  ...
  topic: "AI regulation policies 2024",
...
export const commentIntelligence = {
  confusionSignals: {
    ...
    confusionSpike: [
      { date: "2024-12-01", level: 45 },
      { date: "2024-12-08", level: 52 },
      { date: "2024-12-15", level: 78 },
      { date: "2024-12-22", level: 65 },
      { date: "2024-12-28", level: 82 },
    ],
  },
  agreementPatterns: {
    commonAgreements: [
