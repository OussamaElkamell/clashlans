      ...
      <div className="container px-4 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <p className="text-lg text-muted-foreground">
            A sample research investigation on AI regulation policies — explore the observed patterns.
          </p>
        </div>
          ...
          <div className="glass-card-elevated p-8 md:p-12">
            ...
            <div className="mb-6 p-3 rounded-lg bg-primary/5 border border-primary/20">
              <div className="flex items-start gap-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Reports generated by ClashLens summarize qualitative research findings and contextual observations. They are not analytics reports and do not replace YouTube-provided metrics.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 pb-8 border-b border-border">
              <div>
                ...
                <p className="text-muted-foreground mt-1">47 videos analyzed • 4 contradiction analysis groups</p>
              </div>
              <Link to="/demo">
